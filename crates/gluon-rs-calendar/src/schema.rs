...
CREATE INDEX IF NOT EXISTS idx_calendar_keys_calendar
    ON calendar_keys(calendar_id);
...
CREATE INDEX IF NOT EXISTS idx_calendar_settings_calendar
    ON calendar_settings(calendar_id);
...
CREATE INDEX IF NOT EXISTS idx_calendar_events_uid
    ON calendar_events(uid);
CREATE INDEX IF NOT EXISTS idx_calendar_events_edit_time
    ON calendar_events(last_edit_time DESC);
