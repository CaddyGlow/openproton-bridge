...
- `BE-032`: in progress; IMAP runtime defaults now point at Gluon, production startup ignores persisted compat backend selections, and CI exercises the Gluon parity suites. Remaining work is the final release-candidate checklist and operator-facing cutover docs.
