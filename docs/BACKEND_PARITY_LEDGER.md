...
- `BE-030`: in progress with IMAP, IDLE, event-worker parity coverage, and a live mail-runtime IMAP probe on the Gluon backend that now covers startup, offline `LOGIN`, and authenticated `LIST`
