...
- `BE-029`: partial because sanitized sqlite fixture artifacts are placeholders, so real upstream cache-open parity remains open; a manual external-archive gate now exists in `tests/gluon_real_fixture.rs`
